# E5T1 — Implement SQLite schema and migrations

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the SQLite schema for users, habits, and completions. Implement migrations to be executed on startup. Ensure indexes are in place for unique constraints.
