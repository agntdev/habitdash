# E2T1 — Implement /add command and habit name input

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the /add command that starts a multi-step flow for adding a new habit. The first step is to prompt the user to type the habit name. Write tests to tests/specs/E2T1.json and append the command to tests/commands.json.
