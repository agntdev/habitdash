# E1T1 — Implement /start command and initial dashboard

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the /start command that shows the user's dashboard. The dashboard should list all habits with their current status and a ✓ Done button for each. Add buttons for Add, Stats, and List. Write tests to tests/specs/E1T1.json and append the command to tests/commands.json.
