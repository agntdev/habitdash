# E6T1 — Enforce private chat usage

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Check if the bot is being used in a private chat. If not, respond with 'This bot works in private chats only. Start a private chat with me.' and ignore further interactions.
