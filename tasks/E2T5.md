# E2T5 — Implement habit confirmation and creation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

After all selections, show a confirmation summary with 'Confirm' and 'Cancel' buttons. On 'Confirm', create the habit in the database and return to the dashboard. Write tests to tests/specs/E2T5.json.
