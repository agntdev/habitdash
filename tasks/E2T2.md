# E2T2 — Implement frequency selection step

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

After the user provides the habit name, show inline buttons for frequency selection: Daily, Weekdays (Mon–Fri), Specific days. Write tests to tests/specs/E2T2.json.
