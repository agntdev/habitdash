# E1T2 — Implement /list command and dashboard refresh

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the /list command that shows all habits with their current streaks. This should update the same dashboard message as /start. Write tests to tests/specs/E1T2.json and append the command to tests/commands.json.
