# E2T4 — Implement reminder time selection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

After frequency selection, show buttons for reminder time: [No reminder] [Set time]. If 'Set time' is selected, present quick times (08:00, 12:00, 18:00) plus a 'Custom' option for HH:MM input. Write tests to tests/specs/E2T4.json.
