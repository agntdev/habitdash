# E2T3 — Implement specific days selection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

If the user selects 'Specific days', show seven weekday toggle buttons (Mon..Sun) for multi-select and a Done button. Write tests to tests/specs/E2T3.json.
