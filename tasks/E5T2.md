# E5T2 — Implement message editing and dashboard recovery

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Store the last dashboard message ID for each user. When a button is pressed, attempt to edit the dashboard message. If editing fails, send a new dashboard message and update the stored message ID.
