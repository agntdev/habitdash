# E4T1 — Implement /stats command and streak display

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the /stats command that shows today's progress (X/Y completed) and the longest streak across all habits. Add a [Back to dashboard] button. Write tests to tests/specs/E4T1.json and append the command to tests/commands.json.
