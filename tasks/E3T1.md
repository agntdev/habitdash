# E3T1 — Implement /check command and ✓ Done button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Create the /check command and the ✓ Done button on the dashboard. When pressed, insert a completion row for the current day (if not already present), update the dashboard in-place, and acknowledge the action. Write tests to tests/specs/E3T1.json and append the command to tests/commands.json.
