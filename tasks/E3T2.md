# E3T2 — Track streaks and update dashboard

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 HBT

Update the dashboard to show the current streak for each habit. When a habit is marked as done, update the streak and display it. Write tests to tests/specs/E3T2.json.
